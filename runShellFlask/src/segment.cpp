...
int main(int argc, char* argv[])
{
    ...
    string TEXT_TO_SEG_FILE = "tmp/"+timestamp+"tokenized_text_to_seg.txt";
    string TEXT_TO_SEG_POS_TAGS_FILE = "tmp/"+timestamp+"pos_tags_tokenized_text_to_seg.txt";
    ...
    string tokenizedSegmentedSentences_filename = "tmp/"+timestamp+"tokenized_segmented_sentences.txt";

    FILE* out = tryOpen(tokenizedSegmentedSentences_filename, "w");
